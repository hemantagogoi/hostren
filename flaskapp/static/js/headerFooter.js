...
const dropdownContainers = document.querySelectorAll('.dropdown_container_2');

dropdownContainers.forEach(container => {
  const toggleElement = container.querySelector('.side_navigation_items:first-child');
  const hiddenItems = container.querySelectorAll('.side_navigation_items.hide');
